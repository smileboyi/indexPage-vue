<template>
  <div class="page-top pre contain w100" style="background-image: url(/img/car-bg.jpg)">
    <login-bar class="pt_login-bar pab not" />
    <div class="left pab hauto2">
      ...
      <el-button class="ptl_btn" round>立即兑换</el-button>
    </div>
    <register-popup class="pab pb_register-popup hauto2" />
  </div>
</template>
